...
_keys = _load_or_abort()

PLAYFAIR_KEY: str = _keys["playfair"]
COLUMNAR_KEY: str  = _keys["columnar"]
DES_KEY_HEX:  str  = _keys["des"]          # hex string; decode before use
DES_KEY:      bytes = bytes.fromhex(_keys["des"])
